...
const Home = () => {
  return (
    <>
        ...
        <section className="w-screen py-[10vh] flex flex-col items-center justify-center relative"><Sponsers /></section>
        ...
        <section className="w-screen py-[10vh] flex flex-col items-center justify-center"><FAQSection /></section>
    </>
  );
};
